<template lang="">
    ...
    <div class="forquestion">
        ...
        <form>
    <label class="next">
      <input type="button" class="nextbutton" value = "ต่อไป" @click="saveAnswer">
    </label>
    <label class="back">
      <a href="http://localhost:5173/startPage">
      <button v-if="step == 1" class="backbutton">กลับ
      </button>
    </a>
    </label>
    <label v-if="step != 1" class="back">
      <button  class="backbutton" @click="this.step--"> กลับ </button>
    </label>
  </form>
    </div>
</template>
